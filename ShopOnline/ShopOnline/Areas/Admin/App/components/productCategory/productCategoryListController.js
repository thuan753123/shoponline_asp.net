(function (app) {
    app.controller('productCategoryListController', function ($scope, $http, commonService, apiService, notificationService) {
        $scope.pageSize = 5;
        ...
        function GetData() {
            ...
            apiService.get('ProductCategories/', null, function (result) {
